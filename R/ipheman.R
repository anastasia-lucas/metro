...
#' @export
#' @examples
#' ipheman(d, format, phegroup, line, log10, yaxis, title, chrcolor1, chrcolor2, groupcolors, db, moreinfo, file, hgt, wi)

ipheman <- function(d, format="plotman", phegroup, line, log10=TRUE, yaxis, highlight_snp, highlight_p, highlighter="red", title=NULL, chrcolor1="#AAAAAA", chrcolor2="#4D4D4D", groupcolors, db, moreinfo=FALSE, file="ipheman", hgt=7, wi=12){
